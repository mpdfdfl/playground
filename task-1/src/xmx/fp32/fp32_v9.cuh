...
{
__global__ void gemm_v9(const size_t M, const size_t N, const size_t K,
...
#pragma unroll
        for (int tk = 0; tk < BK; tk++) {
            ...
            FLOAT4(r_comp_b[4]) = FLOAT4(s_b[smem_sel][tk][tx * TN + 4]);
...
#pragma unroll
    for (int tk = 0; tk < BK; tk++) {
        ...
        FLOAT4(r_comp_b[4]) = FLOAT4(s_b[1][tk][tx * TN + 4]);
