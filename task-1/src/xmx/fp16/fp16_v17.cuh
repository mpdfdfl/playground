...
// blockDIM 32 2 4
__global__ void gemm_fp16_v17(const float16_t* A, const float16_t* B,
            ...
            for (int mii = 0; mii < MII / mmaM; mii += 1) {
                for (int nii = 0; nii < NII / mmaN; nii += 1) {
                    asm volatile(
                        ...
                        "{%6,  %7},"
                        "{%8, %9};\n"
                        : "=r"(Accum[mii][nii][0]), "=r"(Accum[mii][nii][1])
                        : "r"(FragA[mii][0]), "r"(FragA[mii][1]),
                          "r"(FragA[mii][2]), "r"(FragA[mii][3]),
                          "r"(FragB[nii][0]), "r"(FragB[nii][1]),
                          "r"(Accum[mii][nii][0]), "r"(Accum[mii][nii][1]));
                    ...
                    asm volatile(
                        ...
                        "{%6,  %7},"
                        "{%8, %9};\n"
                        : "=r"(Accum[mii][nii][2]), "=r"(Accum[mii][nii][3])
                        : "r"(FragA[mii][0]), "r"(FragA[mii][1]),
                          "r"(FragA[mii][2]), "r"(FragA[mii][3]),
                          "r"(FragB[nii][2]), "r"(FragB[nii][3]),
                          "r"(Accum[mii][nii][2]), "r"(Accum[mii][nii][3]));
                }
            }
        }
